...
public class PathogenSearchService {

  private final FhirDataTranslationProxy fhirDataTranslationProxy;

  public PathogenData findByCode(String code) {
    log.debug("searching pathogen with code {} ", code);
    return fhirDataTranslationProxy.findByCode(code).getBody();
  }

  public List<CodeDisplay> findAll() {
    return fhirDataTranslationProxy.findAll().getBody();
  }
}

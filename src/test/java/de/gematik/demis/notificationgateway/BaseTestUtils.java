...
public interface BaseTestUtils {
  ...
  default String getHospitalizationString() {
    return FileUtils.loadJsonFromFile("/portal/disease/notification-unknown-use-case.json");
  }
  ...
  default Parameters createXmlOkParameters(String path) throws URISyntaxException, IOException {
    return (Parameters) FhirContext.forR4().newXmlParser().parseResource(getJsonContent(path));
  }

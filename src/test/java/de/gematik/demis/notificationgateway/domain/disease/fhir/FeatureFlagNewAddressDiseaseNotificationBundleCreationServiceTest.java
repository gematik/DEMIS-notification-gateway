...
@TestPropertySource(properties = "feature.flag.disease_address_patient=true")
class FeatureFlagNewAddressDiseaseNotificationBundleCreationServiceTest {
  ...
  @ParameterizedTest
  @CsvSource({
    "portal/disease/patient.address/input-current-address-is-primary-as-current.json, portal/disease/patient.address/output-current-address-is-primary-as-current.json",
    "portal/disease/patient.address/input-current-address-is-other-facility.json, portal/disease/patient.address/output-current-address-is-other-facility.json",
    "portal/disease/patient.address/input-current-address-is-submitting-facility.json, portal/disease/patient.address/output-current-address-is-submitting-facility.json"
  })

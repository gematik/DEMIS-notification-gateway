...
public class BedOccupancyRestController {
  ...
  public ResponseEntity<OkResponse> addBedOccupancyReport(
      @RequestBody final @Valid BedOccupancy content, @RequestHeader Map<String, String> headers)
      throws BadRequestException {
    log.debug("Received bed occupancy report.");
    final OkResponse okResponse =
        bedOccupancyService.handleBedOccupancy(content, this.testUserProperties.clientIp(headers));

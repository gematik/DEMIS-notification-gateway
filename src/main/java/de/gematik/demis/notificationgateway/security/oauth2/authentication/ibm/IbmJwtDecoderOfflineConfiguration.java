...
public class IbmJwtDecoderOfflineConfiguration {
  ...
  public NimbusJwtDecoder jwtDecoder() throws IOException, ParseException, URISyntaxException {
    log.warn("creating development IBM jwtDecoder");
    final URL jwkSetUrl = getClass().getClassLoader().getResource("idp/ibm-jwk-set.json");

...
package de.gematik.demis.notificationgateway.domain.pathogen.proxies;
...
@FeignClient(
    name = "fhir-data-translation-service",
    url = "${fhir-data-translation-service.url}",
    configuration = CustomFeignConfigurator.class)
public interface FhirDataTranslationProxy {

  @GetMapping("/laboratory")
  ResponseEntity<List<CodeDisplay>> findAll();

  @GetMapping("/laboratory/{code}")

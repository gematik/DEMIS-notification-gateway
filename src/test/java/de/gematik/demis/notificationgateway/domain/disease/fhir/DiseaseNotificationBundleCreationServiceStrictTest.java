...
@TestPropertySource(properties = "feature.flag.diseaseStrictProfile=true")
class DiseaseNotificationBundleCreationServiceStrictTest {
  ...
  @AfterAll
  static void resetConfiguredCodeSystemsInstance() {
    ReflectionTestUtils.setField(ConfiguredCodeSystems.class, "instance", null);
  }

  @ParameterizedTest
  @CsvSource({
    "portal/disease/notification-formly-input.json, portal/disease/strict/notification-formly-output.json",
    "portal/disease/notification-formly-rund-input.json, portal/disease/strict/notification-formly-rund-output.json",
    "portal/disease/patient.address/current-address-is-primary-as-current-input.json, portal/disease/strict/current-address-is-primary-as-current-output.json",
    "portal/disease/patient.address/current-address-is-other-facility-input.json, portal/disease/strict/current-address-is-other-facility-output.json",
    "portal/disease/patient.address/current-address-is-submitting-facility-input.json, portal/disease/strict/current-address-is-submitting-facility-output.json"
  })
  ...
  private void testBundleCreation(String outputFile) throws BadRequestException {
    final Bundle bundle = this.service.createBundle(this.input, NotificationType.NOMINAL);

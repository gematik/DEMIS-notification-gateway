...
public class MessageConstants {
  ...
  public static final String JWT_TOKEN_AUTHENTICATION_FAILED = "JWT Token validation failed";
  public static final String FAILED_TO_EXTRACT_IK_NUMBER = "failed to extract the IK number";
  ...
  public static final String MISSING_VACCINATION_DATE_OF = "missing vaccination date of: ";

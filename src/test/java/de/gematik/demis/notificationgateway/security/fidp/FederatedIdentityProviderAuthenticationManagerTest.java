...
class FederatedIdentityProviderAuthenticationManagerTest {
  @Test
  void expectManagerToOnlySetAuthenticationToTrue() {
    FederatedIdentityProviderAuthenticationManager manager =

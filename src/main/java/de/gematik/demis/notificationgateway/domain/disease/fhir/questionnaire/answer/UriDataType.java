...
final class UriDataType implements DataType<UriType> {

  @Override
  public UriType toFhir(QuestionnaireResponseAnswer answer) {
    return new UriType(getValue(answer));
  }

  @Override
  public boolean test(QuestionnaireResponseAnswer answer) {
    return StringUtils.isNotBlank(answer.getValueUri());
  }

  private String getValue(QuestionnaireResponseAnswer answer) {
    return Objects.requireNonNull(answer.getValueUri(), "uri value not set");
  }
}
